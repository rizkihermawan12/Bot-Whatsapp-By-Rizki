...
//
const BotName = 'botRizkiXgans'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/hermawanrisky02'; // Nama Instagramlu cok
const whatsapplu = '0858-0363-9392'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/CUXoVBDqK1IJZpVpl2InVx'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/KKhGOzBxIqgC1sZT2CCpgA'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.sendMessage(id, '3aalaikumsalam, ada yang bisa saya bantu? kalo bingung ketik #help ya..' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, 'Waalaikumsalam, ada yang bisa saya bantu? kalo bingung ketik #help ya..' ,MessageType.text);
}
...
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? kalo bingung ketik #help ya..' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? kalo bingung ketik #help ya..' ,MessageType.text);
}
