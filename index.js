...
//
const BotName = 'BOT RIZKI HERMAWAN 🤖'; // Nama Bot Whatsapp
...
const grupch1 = 'https://chat.whatsapp.com/KKhGOzBxIqgC1sZT2CCpgA'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/CUXoVBDqK1IJZpVpl2InVx'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Scan Kode Qr Mu Zayank`);
});
